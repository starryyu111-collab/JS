...
INT8-MinMax remains close to FP32, with 94.1100\% Top-1 accuracy compared with 94.1300\% for FP32. In contrast, INT4-MinMax drops to 88.2000\%, a 5.9300 percentage-point decrease. Both clipping variants alleviate this degradation: INT4-P99.9 reaches 92.9700\%, while INT4-MSE-Selected reaches 92.8600\%. Compared with INT4-MinMax, INT4-MSE-Selected improves Top-1 accuracy and reduces the accuracy drop from 5.9300 to 1.2700 percentage points.
