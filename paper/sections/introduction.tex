...
Aggressive INT4 activation quantization makes post-training quantization (PTQ) sensitive to calibration choices. Rare large post-ReLU values can dominate MinMax calibration, expand the quantization range, and reduce the effective resolution assigned to common activation values. In the evaluated setting, activation clipping addresses this issue by trading limited saturation of large values for reduced rounding error over the main activation distribution.
